"""
Django settings for datadocai project.
...
SECRET_KEY = 'django-insecure-y0l_)5+zf@7@(3n!av3o2gk7$u*vzg(^oxr9rlcx+6!i!x*(6&'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('POSTGRES_USER'),  # Your database username
